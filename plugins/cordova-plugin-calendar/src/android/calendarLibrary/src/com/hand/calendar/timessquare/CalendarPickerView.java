...
public class CalendarPickerView extends ListView {
  ...
  public void setBanDate(BanDate banDate){
...
//      }
  ...
  private void clearOldSelections() {
    if(banDate!=null&&defaultMonthCellDescriptor!=null&&!isFirst){
      selectedCells.add(defaultMonthCellDescriptor);
    }
    isFirst = false;
    for (MonthCellDescriptor selectedCell : selectedCells) {
...
//            isCurrentMonth && betweenDates(cal, minCal, maxCal) && isDateSelectable(date);
        if(banDate!=null && banDate.isSelected(date)){
          isSelected = true;
        }
        boolean isSelectable;
        if(banDate == null){
          ...
          isSelectable = !banDate.isBanDate(date);
        }
        ...
        MonthCellDescriptor monthCellDescriptor = new MonthCellDescriptor(date, isCurrentMonth, isSelectable, isSelected, isToday,
          isHighlighted, value,valuemonth,valueyear, rangeState);
        if(banDate!=null&&isSelected){
          defaultMonthCellDescriptor = monthCellDescriptor;
        }
  ...
  private MonthCellDescriptor defaultMonthCellDescriptor;
